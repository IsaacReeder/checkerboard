...
@app.route('/checkerboard/<i>/<j>/', methods=['GET'])                           # The "@" symbol designates a "decorator" which attaches the
...
def checkerboard(i,j):
    return render_template("checkerboard.html")      # Render the template and return it!
